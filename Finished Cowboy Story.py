...
def intro():
	sleep(0.5)
	print("""
Your cousin has written to you saying that he is in dire need of help. He hasn’t specified
what he needs help with, but you oblige. He lives in a town in the middle of the desert. You
decided to bring 20 dollars and a pistol. You need a way to get there, but you need to
decide whether to go by horse or by train.
""")
	sleep(0.3)
...
def train():
	print("""
The train running to Bone Dry Gulch wasn’t exactly known for being safe. It was mainly
used for carrying freight, but occasionally carried passengers.Today was a busier day
than usual, with the train carrying upwards of 30 passengers.You knew this route was
infamous for being robbed, but you felt safer since there were more passengers, therefore
more people to fend off the bandits. You went to grab tickets at the nearest opportunity.

As you boarded the train, dread still hung in the air despite your previous reasoning. You
could still go by horse if you really wanted to.""")
	sleep(0.3)
	input("\nPress the enter key to continue.\n")
	sleep(0.5)
	...
	while True:      
		...
		if choice1 == "1":
			sleep(0.5)
			print("\nYou decide to continue by train.\n")
			lines()
			board()
			break
		elif choice1 == "2":
			sleep(0.5)
			print("\nYou decide to abandon the train and go by horse.\n")
			lines()
			abandon()
			break
		else:
...
_ /_//___\\\
    ``    ``""")
	print("""
You choose to go by horse because it is safer in the long run. While going on the trail to
your cousin you meet some old friends of yours, lead by Richard, who you know well.

“Hey old friend of mine. I heard your cousin needs some help down at the town.”

“Yeah he does. Why do you ask?”

“ Oh, we are heading the same way. Going to have some fun with the train going by there.
...
You and the group of bandits ride on for a couple hours. While the bandits are resting,
Richard tells you what the plan is.

“After the train leaves we will chase at a safe distance for a little while. Then we will have
three separate groups split up. The first group, led by yours truly, will gather 'donations'
from the passengers as our second group, led by Joe, attacks the conductor and stop the train.
The third group, headed by Jesse will make sure no one will come and mess this up.”
...
\\__|__|__//
   ...
   \____/""")
	...
	print("Good choice.")
	print("""
The bandits break up camp. You go off with Richard to ride close to the train without
being seen. When you get the signal from Joe's group that they are ready to ride, you get
closer to the train. As you get closer, you hear screams from the passengers as they spot you.
The train is starting to slow and you let out a whoop of joy as it stops. Richard steps
off his horse and you closely follow. Richard goes in first and gives his speech on robbing
and cooperating. Everyong is scared and no one causes trouble. You run off with the
bandits and a lot of money.""")
	sleep(0.3)
	input("\nPress the enter key to continue.\n")
	sleep(0.5)
	print("END")
...
\\__|__|__//
   ...
   \____/""")
	...
	print("""
You and the rest of Joe's group breaks off before camp is broken down to be by the front
of the train. When you get the signal to move into action and jump on the train, the
conductors try to fight back. However, they are overwhelmed by the sheer numbers of
your group. After you slow the train down you wait and watch as Richard robs the train
passengers. When the bandits regroup, they split up the money and let you continue on
your way to your cousin.""")
	sleep(0.3)
	input("\nPress the enter key to continue.\n")
	sleep(0.5)
	print("END")
...
\\__|__|__//
   ...
   \____/""")
	...
	print("""
Your group does most of the breaking up of camp because of the fact that your group is
the last one to leave. You get the signal from Richard's group and spread out around the
back and sides watching for cops. Sadly for you, no cops came to give the robbery any
trouble. After what felt like forever, you leave the train with the bandits, hopingto get a
bigger share of the money then you fear you will get. You get a decent share, 
but not as much as the other bandits because you didn't do as much.""")
	sleep(0.3)
	input("\nPress the enter key to continue.\n")
	sleep(0.5)
	print("END")
...
""")
    sleep(0.3)
    print("""
Despite your fears, you push on and board the train. It seems like you’ll be quite
comfortable here. The seats are plush, each having a small pillow in case you fell asleep.
...
the opposite train car. You, suspecting an attack at any moment, rest your hand on your
pistol, hoping that it was just an accident and not something worse. As you listen, booming
footsteps come from the other train car. You barely have any time to prepare, but you
come up with several ideas to avoid being robbed in case those footsteps were from
thieving bandits.""")
    sleep(0.3)
    input("\nPress the enter key to continue.\n")
    sleep(0.5)
...
def abandon():
    print("""
Your hunch caused you to abandon the train and instead go by horse alone. You saddle up
...
def decline():
    print("""
“Yeah, I’m not up for that sort of thing.”
“Suit yourself.”
...
def asleep():
    print("""
You promptly close your eyes and slump over, pretending you’re asleep. Following
...
def gun():
    print("""
You pull out your pistol in anticipation of a robbery. Following another large door slam,
